...
load("240212_q_kfz_traffic_model_full_period.Rdata")# model object
load("240212_q_kfz_model_descr.Rdata") # model description
DEV <- Sys.getenv("DEV")
...
preds_chunkwise_to_db(
  chunk_size = 7,
  query = "features_on_grid_nov21_oct22",
  xgb_fit = xgb_fit,
  target_variable = target_variable,
  model_id =  model_descr$model_id,
...
preds_to_db(
  query = "features_at_passive_samplers",
  xgb_fit = xgb_fit,
  model_id = model_descr$model_id,
